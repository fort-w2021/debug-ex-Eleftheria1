...
Die Ursache des problems ist der Aufruf von plot in zeile 7 der plot_scatterhist fkt. Hier bei wird xlab als "" string übergeben, dies führt dazu, dass während des versuchs die einzelnen plots für ein pairplot zu erzeugen das argument xlab nicht zugeordnet werden kann (auslöser). 
